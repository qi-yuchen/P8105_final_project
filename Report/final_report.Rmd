...
Both related to money, what's the association between these two variable and happiness? To answer this question, we use the following three variables to find the best linear model that describes the association: life_ladder, gdp and generosity. Detailed data description is in the data part below.
