...
## Finding the passcode of Happliness(note: motivation)
...
## Which model is closest to the 'true passcode'? (note:how to choose the model)



## Hooray! Now we obtained the passcode of Happiness! (note:summary of final model)



## Wait! There's more we can expect with this passcode... (note:further)
